...
extern PRECISION vec2 sepiaShader;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    //vec2 rotater = vec2(cos(sepiaShader.r*0.1221), sin(sepiaShader.r*0.3512));

    vec3 sepiaShaderVec = tex.rgb;
    if (sepiaShader.g > 0.0 || sepiaShader.g < 0.0) {
        sepiaShaderVec.r = (tex.r * 0.393) + (tex.g * 0.769) + (tex.b * 0.189);
        sepiaShaderVec.g = (tex.r * 0.349) + (tex.g * 0.686) + (tex.b * 0.168);
        sepiaShaderVec.b = (tex.r * 0.272) + (tex.g * 0.534) + (tex.b * 0.131);
    }

    tex = vec4(sepiaShaderVec, tex.a);
