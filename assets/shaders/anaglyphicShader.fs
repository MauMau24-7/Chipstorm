...
extern PRECISION vec2 anaglyphicShader;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float displacement_x = (0.1*cos(anaglyphicShader.g*0.3)+0.3)/texture_details.b;
    float displacement_y = (0.03*sin(anaglyphicShader.r)+0.03)/texture_details.a;
    ...
    if (anaglyphicShader.g > 0.0 || anaglyphicShader.g < 0.0) {
        red_tex = RGB(red_tex);
