...
extern PRECISION vec2 greyscaleShader;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float t = greyscaleShader.g + time;
    ...
    //vec2 rotater = vec2(cos(greyscaleShader.r*0.1221), sin(greyscaleShader.r*0.3512));


    if (greyscaleShader.g > 0.0 || greyscaleShader.g < 0.0) {
        hsl.y = 0.02;
        hsl.z *= (1 - adjusted_uv.x*(cos(greyscaleShader.r*0.512)));
        hsl.z *= (1 - adjusted_uv.y*(cos(greyscaleShader.r*0.512)));
    }
